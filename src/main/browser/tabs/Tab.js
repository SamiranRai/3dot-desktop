...
#Event Flow:
(chromium:Emit) -> (Listen) "did-start-loading" -> (updateBrowserState:Emit) "tab-state-changed"
(chromium:Emit) -> (Listen) "did-stop-loading" -> (updateBrowserState:Emit) "tab-state-changed"
(chromium:Emit) -> (Listen) "did-navigate" -> (updateBrowserState:Emit) "tab-state-changed"
(chromium:Emit) -> (Listen) "page-title-updated" -> (updateBrowserState:Emit) "tab-state-changed"
*/
...
class Tab extends EventEmitter {
  ...
  // Update the browser state and emit a tab-state-changed event
  updateBrowserState(patch) {
    Object.assign(this.browserState, patch);
    this.emit("tab-state-changed", this.browserState.getSnapshot());
  }
